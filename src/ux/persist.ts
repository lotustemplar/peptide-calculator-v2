...
/**
 * Commit fills/schedules/occurrences as one recoverable unit.
 * Envelope setItem is the atomic boundary: throw => pre-op on reload.
 * Mirror writes are best-effort after a successful envelope.
 */
export function commitAppState(storage: StorageLike, next: AppPersistState): void {
