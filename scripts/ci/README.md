...
| Test runner | `scripts/test.js` | Gate self-tests, P0.1 calculator tests, P0.6 copy tests, P0.OCC, P0.UX, Stage 2 chrome/assets, Stage 3 persist, Stage 4–6b checks, or Stage 6c-B1/B2/B3 recovery checks fail |
...
Stage 6b.1 `export-fix.js`, Stage 6b.2 `mobile-polish-fix.js`, Stage 6b.3
`ui-polish-fix.js`, and Stage 6b.4 `native-backup-fix.js` retirement
(`runtime-fixes.js` only).
